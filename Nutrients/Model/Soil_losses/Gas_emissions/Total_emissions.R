...
compute_gaseous_emissions_field_app = function(gas, manure_surplus_fills_nutDemand = F, manure_method = 'Method 1', nutrient = 'N') {
  ...
  if (gas == 'NH3') {
    ...
    biosolids = get_activity_data(module = 'Nutrients', mainfolder = 'Output', folder = 'Gas_N_emissions', subfolder = gas, subfolderX2 = 'Biosolid_application', subfolderX3 = manure_method, subfolderX4 = folder_div, subfolderX5 = 'Total', pattern = 'Total')
    fert  = get_activity_data(module = 'Nutrients', mainfolder = 'Output', folder = 'Gas_N_emissions', subfolder = gas, subfolderX2 = 'Inorganic_fertiliser', subfolderX3 = manure_method, subfolderX4 = folder_div, subfolderX5 = 'Total', pattern = 'Total')
    man_app = get_activity_data(module = 'Nutrients', mainfolder = 'Output', folder = 'Gas_N_emissions', subfolder = gas, subfolderX2 = 'Manure_application', subfolderX3 = manure_method, subfolderX4 = folder_div, subfolderX5 = 'Total',  pattern = 'Total')
...
compute_gaseous_emissions_MMS = function(gas) {
  ...
  for (i in params) {
    ...
    if (i == 'Grazing' & (gas == 'N2O' | gas == 'NOx')) {
      N_emissions = get_activity_data(module = 'Nutrients', mainfolder = 'Output', folder = 'Gas_N_emissions', subfolder = gas, subfolderX2 = i, subfolderX3 = 'Total',  pattern = 'Total')
    }
    else {
...
compute_total_gaseous_emissions = function(gas, manure_surplus_fills_nutDemand = F, manure_method = 'Method 1', nutrient = 'N') {
  ...
  if (gas != 'NN2') {
    ...
    tot_emissions = compute_gaseous_emissions_MMS(gas)
  }
