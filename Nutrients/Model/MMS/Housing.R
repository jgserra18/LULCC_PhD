...
source('./Nutrients/Model/MMS/TAN_conversion/Convert_N_to_TAN_flows.R')
...
compute_housing_NH3_emissions <- function(main_param, param, manure_type) {
  ...
  house_maN <-  get_activity_data(module = 'Nutrients', mainfolder = 'Output',  folder = 'Gross_manure', subfolder = 'N', subfolderX2 = 'Yards', subfolderX3 =manure_type, subfolderX4 = main_param, pattern = param)
...
general_func_animal_bedding <- function(main_param, param, bedding_param) {
  ...
  bedding_params <- get_activity_data(module = 'Nutrients', subfolder = 'Nutrient_params', subfolderX2 = 'N', subfolderX3 = 'MMS', subfolderX4 = 'Other_params', pattern = bedding_param)
  bedding_params <- subset(bedding_params, Animal == param)
  bedding_params <- bedding_params[, 'Straw']
